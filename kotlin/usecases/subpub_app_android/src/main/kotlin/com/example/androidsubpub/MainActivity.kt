...
class MainActivity :
    ...
    fun checkEmail(email: String?): Boolean = emailAddressPattern.matcher(email).matches()

    val emailAddressPattern: Pattern =
        Pattern.compile(
            "[a-zA-Z0-9\\+\\.\\_\\%\\-\\+]{1,256}" +
                "\\@" +
